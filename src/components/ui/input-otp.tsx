...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex h-9 w-9 items-center justify-center border-y border-r text-sm bg-input-background dark:bg-input/30 border-input transition-all outline-none",
