  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-mono transition-all duration-300 disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#00E0A4] relative overflow-hidden group",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-[#2F2F33] bg-[#0D0D0F] text-[#E8E8E8] hover:bg-[#151519] hover:border-[#2979FF]/50 hover:text-white shadow-sm hover:shadow-elevated transition-all",
        secondary:
        ...
        link: "text-[#2979FF] underline-offset-4 hover:underline hover:text-[#00E0A4]",
        ...
        success: "bg-gradient-to-r from-[#00E0A4] to-[#06FFA5] text-[#0D0D0F] font-semibold shadow-elevated hover:shadow-elevated-hover hover:from-[#00f5b8] hover:to-[#1bffb4]",
        warning: "bg-gradient-to-r from-[#FFB84D] to-[#FF9800] text-white shadow-elevated hover:shadow-elevated-hover",
      },
      size: {
